...
<body>
    ...
    <div class="wrappertwo">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <h2>Player Rule</h2>
                    <ul>
                        <li>Only 7 Players a side + 4 Substitutes Player</li>
                    </ul>

                    <h2>Over Rule</h2>
                    <ul>
                        <li>For Group Matches 4 Overs per innings</li>
                    <li>For Knockout Matches 6 Overs per innings</li>
                    </ul>

                    <h2>Over Limit</h2>
                    <ul>
                        <li>For 4 overs match : 1 Bowler/Over</li>
                        <li>For 6 overs match: 2 Bowlers 2 overs max (remaining 2 overs 1 Bowler/Over)</li>
                    </ul>
        ...
        <footer class="footer Squadfooter">
            <div class="container">
